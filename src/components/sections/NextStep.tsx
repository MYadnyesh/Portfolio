...
export function NextStep() {
  return (
    <section id="next-step" className="section bg-[var(--color-bg)] text-[var(--color-fg)]">
      <div className="container">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[var(--color-fg-muted)] mt-6 max-w-2xl leading-relaxed">
