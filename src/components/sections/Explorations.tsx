    ...
    <section id="explorations" className="section">
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title mt-3 font-bold uppercase">In the <span className="text-serif-italic lowercase text-accent-readable">lab</span></h2>
                ...
                <div className="lg:col-span-2">
                  <div className="flex flex-wrap gap-1.5 lg:justify-end">
                    {exploration.stack.map((tech) => (
                      <span key={tech} className="font-mono text-xs text-fg-subtle">
                        {tech}
                      </span>
                    ))}
                  </div>
        ...
        >
          <p className="text-fg-muted leading-relaxed">
            <span className="text-fg font-display">Exploration is not distraction.</span>{" "}
