    ...
    <section id="explorations" className="section">
      <div className="container">
        ...
        >
          ...
          <h2 className="section-title mt-3 font-bold uppercase">In the <span className="text-serif-italic lowercase text-(--color-accent-readable)">lab</span></h2>
            ...
            >
              <div className="grid lg:grid-cols-12 gap-3 lg:gap-8">
                ...
                <div className="lg:col-span-5">
                  <p className="text-(--color-fg-muted) text-base md:text-lg leading-relaxed">
                ...
                <div className="lg:col-span-2">
                  <div className="flex flex-wrap gap-1.5 lg:justify-end">
                    {exploration.stack.map((tech) => (
                      <span key={tech} className="font-mono text-xs text-(--color-fg-subtle)">
                        {tech}
                      </span>
                    ))}
                  </div>
        ...
        >
          <p className="text-(--color-fg-muted) leading-relaxed">
            <span className="text-(--color-fg) font-display">Exploration is not distraction.</span>{" "}
