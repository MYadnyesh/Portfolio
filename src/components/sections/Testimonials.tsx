          ...
          <div className="flex items-end justify-between gap-6 flex-wrap">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-11 h-11 flex items-center justify-center border border-current/30 rounded-[var(--radius-md)] transition-colors hover:bg-[var(--color-bg)] hover:text-[var(--color-fg)]"
              >
        ...
        >
          {testimonials.map((t, i) => (
            <motion.article
              ...
              className="snap-start shrink-0 w-[85%] sm:w-[380px] bg-[var(--color-bg)] text-[var(--color-fg)] border border-[var(--color-border)] rounded-[var(--radius-lg)] p-6"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="font-mono text-[0.65rem] uppercase tracking-[0.08em] text-[var(--color-fg-subtle)] border border-[var(--color-border-strong-solid)] rounded-[var(--radius-sm)] px-1.5 py-0.5">
                      {t.handle}
                    </span>
                  </div>
                  <p className="font-mono text-[0.65rem] uppercase tracking-[0.08em] text-[var(--color-fg-subtle)] mt-1">
                    {t.timestamp}
                  </p>
                </div>
              </div>
              <p className="text-sm leading-relaxed text-[var(--color-fg-muted)] mt-4 whitespace-pre-line">
                {t.body}
              </p>
            </motion.article>
          ))}
